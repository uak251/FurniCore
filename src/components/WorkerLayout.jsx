...
export function WorkerLayout({ children }) {
    ...
    const workerCommandItems = [
        { href: "/worker-portal", label: "Worker Dashboard", group: "Worker Portal", keywords: "worker dashboard" },
        { href: "/worker-portal/profile", label: "Profile", group: "Worker Portal", keywords: "profile account" },
        { href: "/worker-portal/preferences", label: "Preferences", group: "Worker Portal", keywords: "theme appearance" },
    ];
