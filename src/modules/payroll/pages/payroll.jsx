...
export default function PayrollPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Payroll" }), _jsx("p", { className: "text-muted-foreground", children: "Generate payroll with transparent attendance penalties and bonuses" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(ModuleInsightsDrawer, { moduleName: "payroll", title: "Payroll Analytics Dashboard", reportId: "payroll-summary", filters: { status: statusFilter } }), _jsxs(Button, { variant: "outline", onClick: () => setShowGallery(true), children: [_jsx(Images, { className: "mr-2 h-4 w-4" }), " Gallery"] }), _jsxs(Button, { variant: "outline", onClick: () => setShowBulk(true), children: [_jsx(Upload, { className: "mr-2 h-4 w-4", "aria-hidden": true }), " Bulk import/export"] }), _jsxs(Button, { onClick: () => setShowGenDialog(true), children: [_jsx(Plus, { className: "mr-2 h-4 w-4", "aria-hidden": true }), " Generate payroll"] })] })] }), totalPending > 0 && (_jsx(Card, { className: "border-amber-200 bg-amber-50 dark:bg-amber-950/10", children: _jsxs(CardContent, { className: "flex items-center justify-between p-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-amber-800 dark:text-amber-200", children: "Pending disbursement" }), _jsx("p", { className: "text-2xl font-bold tabular-nums text-amber-700 dark:text-amber-300", children: fmt(totalPending) })] }), _jsx(AlertTriangle, { className: "h-8 w-8 text-amber-500/60", "aria-hidden": true })] }) })), _jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [_jsxs(Select, { value: filterMonth, onValueChange: setFilterMonth, children: [_jsx(SelectTrigger, { className: "w-28", children: _jsx(SelectValue, { placeholder: "All months" }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "all", children: "All months" }), MONTHS.map((m, i) => _jsx(SelectItem, { value: String(i + 1), children: m }, i + 1))] })] }), _jsxs(Select, { value: filterYear, onValueChange: setFilterYear, children: [_jsx(SelectTrigger, { className: "w-24", children: _jsx(SelectValue, {}) }), _jsx(SelectContent, { children: years.map(y => _jsx(SelectItem, { value: String(y), children: y }, y)) })] })] }), _jsx(TableToolbar, { id: TABLE_ID, entityLabel: "payroll records", searchValue: search, onSearchChange: setSearch, searchPlaceholder: "Search by employee name\u2026", filterLabel: "Status", filterValue: statusFilter, onFilterChange: setStatusFilter, filterOptions: [{ value: "all", label: "All" }, { value: "pending", label: "Pending" }, { value: "approved", label: "Approved" }], sortKey: sortKey, onSortKeyChange: setSortKey, sortOptions: [
                ...
                ], sortDir: sortDir, onSortDirChange: setSortDir, pageSize: pageSize, onPageSizeChange: setPageSize, onExportCsv: exportCsv, exportDisabled: displayed.length === 0, resultsText: total === 0 ? "No matching payroll records" : `Showing ${from}–${to} of ${total}` }), _jsx(Card, { children: _jsx(CardContent, { className: "p-0", children: isLoading ? (_jsx("div", { className: "space-y-3 p-6", children: [1, 2, 3, 4].map(i => _jsx(Skeleton, { className: "h-14 w-full" }, i)) })) : pageRows.length === 0 ? (_jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-muted-foreground", children: [_jsx(Banknote, { className: "mb-3 h-10 w-10", "aria-hidden": true }), _jsx("p", { children: "No payroll records found." }), _jsx(Button, { size: "sm", variant: "outline", className: "mt-3", onClick: () => setShowGenDialog(true), children: "Generate payroll to get started" })] })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "space-y-3 p-3 md:hidden", children: pageRows.map((p) => (_jsxs(Card, { className: "border-border/70", children: [_jsxs(CardContent, { className: "space-y-3 p-4", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx(RecordAvatar, { entityType: "payroll", entityId: p.id, className: "h-10 w-10" }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "truncate font-semibold", children: p.employeeName || `Employee #${p.employeeId}` }), _jsxs("p", { className: "text-xs text-muted-foreground", children: [MONTHS[(p.month ?? 1) - 1], " ", p.year] })] }), _jsx(Badge, { variant: p.status === "approved" ? "default" : "secondary", className: p.status === "approved" ? "bg-green-100 text-green-800" : "", children: p.status === "approved" ? "Approved" : "Pending" })] }), _jsxs("div", { className: "grid grid-cols-2 gap-2 text-sm", children: [_jsxs("p", { className: "text-muted-foreground", children: ["Base: ", _jsx("span", { className: "font-medium text-foreground", children: fmt(Number(p.baseSalary ?? 0)) })] }), _jsxs("p", { className: "text-muted-foreground", children: ["Net: ", _jsx("span", { className: "font-semibold text-foreground", children: fmt(Number(p.netSalary ?? 0)) })] }), _jsxs("p", { className: "text-muted-foreground", children: ["Bonuses: ", Number(p.bonus ?? 0) > 0 ? `+${fmt(Number(p.bonus))}` : "—"] }), _jsxs("p", { className: "text-muted-foreground", children: ["Deductions: ", Number(p.deductions ?? 0) > 0 ? `−${fmt(Number(p.deductions))}` : "—"] })] }), _jsxs("div", { className: "flex flex-wrap justify-end gap-2 border-t pt-2", children: [_jsx(Button, { size: "sm", variant: "outline", className: "touch-target", onClick: () => setAdjRecord(p), children: "Adjustments" }), _jsx(Button, { size: "sm", variant: "outline", className: "touch-target", onClick: () => setImagesPayrollId(p.id), children: "Docs" }), p.status !== "approved" && (_jsx(Button, { size: "sm", variant: "outline", className: "touch-target", onClick: () => handleApprove(p.id), children: "Approve" })), _jsx(Button, { size: "sm", variant: "ghost", className: "touch-target", onClick: () => setExpandedId(expandedId === p.id ? null : p.id), children: expandedId === p.id ? "Hide breakdown" : "Show breakdown" })] }), expandedId === p.id && _jsx(BreakdownPanel, { payrollId: p.id, notes: p.notes })] })] }, p.id))) }), _jsx("div", { className: "hidden overflow-x-auto md:block", children: _jsxs(Table, { children: [_jsx(TableHeader, { children: _jsxs(TableRow, { children: [_jsx(TableHead, { scope: "col", className: "w-8" }), _jsx(TableHead, { scope: "col", className: "w-12" }), _jsx(TableHead, { scope: "col", children: "Employee" }), _jsx(TableHead, { scope: "col", children: "Period" }), _jsx(TableHead, { scope: "col", className: "text-right", children: "Monthly Base" }), _jsx(TableHead, { scope: "col", className: "text-right", children: "Bonuses" }), _jsx(TableHead, { scope: "col", className: "text-right", children: "Deductions" }), _jsx(TableHead, { scope: "col", className: "text-right", children: "Net Pay" }), _jsx(TableHead, { scope: "col", children: "Status" }), _jsx(TableHead, { scope: "col", children: "Actions" })] }) }), _jsx(TableBody, { children: pageRows.map((p) => {
