...
function EmployeesTab() {
    ...
    const { data: allImages = [], isLoading: galleryImagesLoading } = useModuleImages("employee");
...
export default function HRPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "HR Portal" }), _jsx("p", { className: "text-muted-foreground", children: "Employee management \u00B7 Attendance \u00B7 Performance evaluations \u00B7 Payroll integration" })] }), _jsx(ModuleInsightsDrawer, { moduleName: "hr", title: "HR Analytics Dashboard", reportId: "hr-dashboard" })] }), _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [_jsxs(TabsList, { className: "w-full sm:w-auto", children: [_jsxs(TabsTrigger, { value: "overview", className: "gap-1.5", children: [_jsx(BarChart3, { className: "h-4 w-4", "aria-hidden": true }), " Overview"] }), _jsxs(TabsTrigger, { value: "employees", className: "gap-1.5", children: [_jsx(Users, { className: "h-4 w-4", "aria-hidden": true }), " Employees"] }), _jsxs(TabsTrigger, { value: "attendance", className: "gap-1.5", children: [_jsx(Clock, { className: "h-4 w-4", "aria-hidden": true }), " Attendance"] }), _jsxs(TabsTrigger, { value: "performance", className: "gap-1.5", children: [_jsx(Star, { className: "h-4 w-4", "aria-hidden": true }), " Performance"] })] }), _jsx(TabsContent, { value: "overview", className: "mt-4", children: _jsx(OverviewTab, { onTabChange: setActiveTab }) }), _jsx(TabsContent, { value: "employees", className: "mt-4", children: _jsx(EmployeesTab, {}) }), _jsx(TabsContent, { value: "attendance", className: "mt-4", children: _jsx(AttendanceTab, {}) }), _jsx(TabsContent, { value: "performance", className: "mt-4", children: _jsx(PerformanceTab, {}) })] })] }));
}
