...
export default function ProductsPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Products" }), _jsx("p", { className: "text-muted-foreground", children: "Manage your product catalog and pricing" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { variant: "outline", onClick: () => setShowGallery(true), children: [_jsx(Images, { className: "mr-2 h-4 w-4" }), "Gallery"] }), _jsxs(Button, { variant: "outline", onClick: () => setShowBulk(true), children: [_jsx(Upload, { className: "mr-2 h-4 w-4", "aria-hidden": true }), "Bulk import/export"] }), _jsxs(Button, { onClick: openCreate, children: [_jsx(Plus, { className: "mr-2 h-4 w-4" }), "Add Product"] })] })] }), _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }), _jsx(Input, { className: "pl-9", placeholder: "Search by name or SKU...", value: search, onChange: (e) => setSearch(e.target.value) })] }), _jsx(Card, { children: _jsx(CardContent, { className: "p-0", children: isLoading ? (_jsx("div", { className: "p-6 space-y-3", children: [1, 2, 3, 4].map((i) => _jsx(Skeleton, { className: "h-14 w-full" }, i)) })) : filtered.length === 0 ? (_jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-muted-foreground", children: [_jsx(Package, { className: "h-10 w-10 mb-3" }), _jsx("p", { children: "No products found" })] })) : (_jsxs(Table, { children: [_jsx(TableHeader, { children: _jsxs(TableRow, { className: "text-muted-foreground hover:bg-transparent", children: [_jsx(TableHead, { className: "w-12" }), _jsx(TableHead, { children: "Name" }), _jsx(TableHead, { children: "SKU" }), _jsx(TableHead, { children: "Category" }), _jsx(TableHead, { className: "text-right tabular-nums", children: "Cost" }), _jsx(TableHead, { className: "text-right tabular-nums", children: "Price" }), _jsx(TableHead, { className: "text-right tabular-nums", children: "Margin" }), _jsx(TableHead, { className: "text-right tabular-nums", children: "Stock" }), _jsx(TableHead, { children: "Status" }), _jsx(TableHead, { className: "w-[100px]", children: _jsx("span", { className: "sr-only", children: "Actions" }) })] }) }), _jsx(TableBody, { children: filtered.map((p) => (_jsxs(TableRow, { className: "hover:bg-muted/40", children: [_jsx(TableCell, { className: "w-12", children: _jsx(RecordAvatar, { entityType: "product", entityId: p.id, className: "h-10 w-10" }) }), _jsx(TableCell, { className: "max-w-[12rem] font-medium sm:max-w-[18rem]", children: _jsx("span", { className: "line-clamp-2 break-words", children: p.name }) }), _jsx(TableCell, { className: "font-mono text-xs text-muted-foreground", children: p.sku }), _jsx(TableCell, { className: "text-muted-foreground", children: p.category || "—" }), _jsx(TableCell, { className: "text-right font-mono tabular-nums", children: formatCurrency(Number(p.costPrice)) }), _jsx(TableCell, { className: "text-right font-mono tabular-nums", children: formatCurrency(Number(p.sellingPrice)) }), _jsxs(TableCell, { className: "text-right font-mono tabular-nums text-green-600", children: [margin(p), "%"] }), _jsx(TableCell, { className: "text-right font-mono tabular-nums", children: Number(p.stockQuantity) }), _jsx(TableCell, { children: _jsx(Badge, { variant: p.isActive ? "default" : "outline", children: p.isActive ? "Active" : "Inactive" }) }), _jsx(TableCell, { children: _jsxs("div", { className: "flex items-center justify-end gap-1", children: [_jsx(Button, { size: "icon", variant: "ghost", onClick: () => openEdit(p), children: _jsx(Pencil, { className: "h-4 w-4" }) }), _jsx(Button, { size: "icon", variant: "ghost", className: "text-destructive", onClick: () => handleDelete(p.id), children: _jsx(Trash2, { className: "h-4 w-4" }) })] }) })] }, p.id))) })] })) }) }), _jsx(Dialog, { open: showBulk, onOpenChange: setShowBulk, children: _jsxs(DialogContent, { className: "max-w-3xl", children: [_jsx(DialogHeader, { children: _jsx(DialogTitle, { children: "Bulk Import / Export \u2014 Products" }) }), _jsx(BulkImportExport, { module: "Products", importEndpoint: "/api/bulk/products/import", exportEndpoint: "/api/bulk/products/export", exportFilename: "products-export.csv", templateHeaders: ["name", "sku", "category", "sellingPrice", "costPrice", "stockQuantity", "description", "isActive"], templateSample: [
