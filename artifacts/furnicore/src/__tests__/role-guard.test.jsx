...
/* ─── helpers ──────────────────────────────────────────────────────────── */
function renderGuard(allowedRoles, userRole, isLoading = false) {
    if (isLoading) {
    ...
    return render(_jsx(RoleGuard, { allowedRoles: allowedRoles, children: _jsx("div", { "data-testid": "protected-content", children: "Secret content" }) }));
}
...
describe("RoleGuard — portal isolation spot checks", () => {
    ...
    it.each(portalCases)("allowedRoles=%j, userRole='%s' → shouldPass=%s", (allowedRoles, userRole, shouldPass) => {
