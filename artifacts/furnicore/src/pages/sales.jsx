...
import { ShoppingCart, FileText, Tag, BarChart3, TrendingUp, Plus, Pencil, Trash2, CheckCircle2, ChevronDown, ChevronUp, AlertTriangle, DollarSign, Image, } from "lucide-react";
...
function DiscountsTab() {
    ...
    const onSubmit = async (data) => {
        try {
            if (editDisc) {
                await updateDiscount.mutateAsync({ id: editDisc.id, ...data, value: Number(data.value), minOrderAmount: Number(data.minOrderAmount), maxUses: data.maxUses ? Number(data.maxUses) : null, expiresAt: data.expiresAt || null });
                toast({ title: "Discount updated" });
            }
            else {
                await createDiscount.mutateAsync({ ...data, value: Number(data.value), minOrderAmount: Number(data.minOrderAmount), maxUses: data.maxUses ? Number(data.maxUses) : null, expiresAt: data.expiresAt || null });
...
export default function SalesPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Sales Manager" }), _jsx("p", { className: "text-muted-foreground", children: "Orders \u00B7 Invoices \u00B7 Discounts \u00B7 Receivables" })] }), _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [_jsxs(TabsList, { className: "w-full sm:w-auto", children: [_jsxs(TabsTrigger, { value: "overview", className: "gap-1.5", children: [_jsx(BarChart3, { className: "h-4 w-4" }), "Overview"] }), _jsxs(TabsTrigger, { value: "orders", className: "gap-1.5", children: [_jsx(ShoppingCart, { className: "h-4 w-4" }), "Orders"] }), _jsxs(TabsTrigger, { value: "invoices", className: "gap-1.5", children: [_jsx(FileText, { className: "h-4 w-4" }), "Invoices"] }), _jsxs(TabsTrigger, { value: "discounts", className: "gap-1.5", children: [_jsx(Tag, { className: "h-4 w-4" }), "Discounts"] }), _jsxs(TabsTrigger, { value: "receivables", className: "gap-1.5", children: [_jsx(TrendingUp, { className: "h-4 w-4" }), "Receivables"] })] }), _jsx(TabsContent, { value: "overview", className: "mt-4", children: _jsx(OverviewTab, { onTabChange: setActiveTab }) }), _jsx(TabsContent, { value: "orders", className: "mt-4", children: _jsx(OrdersTab, {}) }), _jsx(TabsContent, { value: "invoices", className: "mt-4", children: _jsx(InvoicesTab, {}) }), _jsx(TabsContent, { value: "discounts", className: "mt-4", children: _jsx(DiscountsTab, {}) }), _jsx(TabsContent, { value: "receivables", className: "mt-4", children: _jsx(ReceivablesTab, {}) })] })] }));
}
