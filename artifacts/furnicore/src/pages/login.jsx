...
function UnverifiedEmailBanner({ email }) {
    ...
    return (_jsxs(Alert, { className: "border-amber-300 bg-amber-50 text-amber-900 mb-4", children: [_jsx(MailWarning, { className: "h-4 w-4 text-amber-600" }), _jsx(AlertTitle, { className: "font-semibold", children: "Email not verified" }), _jsxs(AlertDescription, { className: "mt-1 space-y-2", children: [_jsxs("p", { className: "text-sm", children: ["Your account (", _jsx("span", { className: "font-medium", children: email }), ") has not been verified yet. Click the link in your verification email to activate your account."] }), sent ? (_jsx("p", { className: "text-sm font-medium text-green-700", children: "\u2713 A new link has been sent." })) : (_jsx(Button, { size: "sm", variant: "outline", className: "mt-1 border-amber-400 bg-amber-50 hover:bg-amber-100 text-amber-800", disabled: resending, onClick: handleResend, children: resending ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "mr-1.5 h-3.5 w-3.5 animate-spin" }), " Sending\u2026"] })) : (_jsxs(_Fragment, { children: [_jsx(RefreshCw, { className: "mr-1.5 h-3.5 w-3.5" }), " Resend verification email"] })) }))] })] }));
}
/* ─── Validation ─────────────────────────────────────────────────────────── */
