...
import { Settings, Globe, BarChart3, ShieldCheck, Info, Palette, CheckCircle2, AlertCircle, ExternalLink, RefreshCw, DollarSign, Users, Loader2, ChevronDown, ChevronUp, Eye, EyeOff, Save, KeyRound, } from "lucide-react";
...
export default function SettingsPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Settings" }), _jsx("p", { className: "text-muted-foreground", children: "Configure currency, Power BI reports, and manage team permissions." })] }), _jsxs(Tabs, { defaultValue: "general", children: [_jsxs(TabsList, { className: "w-full sm:w-auto", children: [_jsxs(TabsTrigger, { value: "general", className: "gap-1.5", children: [_jsx(Globe, { className: "h-4 w-4" }), " General"] }), _jsxs(TabsTrigger, { value: "powerbi", className: "gap-1.5", children: [_jsx(BarChart3, { className: "h-4 w-4" }), " Power BI"] }), me?.role === "admin" && (_jsxs(TabsTrigger, { value: "access", className: "gap-1.5", children: [_jsx(ShieldCheck, { className: "h-4 w-4" }), " Access Control"] })), me?.role === "admin" && (_jsxs(TabsTrigger, { value: "themes", className: "gap-1.5", children: [_jsx(Palette, { className: "h-4 w-4" }), " Portal themes"] })), _jsxs(TabsTrigger, { value: "about", className: "gap-1.5", children: [_jsx(Info, { className: "h-4 w-4" }), " About"] })] }), _jsx(TabsContent, { value: "general", className: "mt-6", children: _jsx(GeneralTab, {}) }), _jsx(TabsContent, { value: "powerbi", className: "mt-6", children: _jsx(PowerBITab, {}) }), me?.role === "admin" && (_jsx(TabsContent, { value: "access", className: "mt-6", children: _jsx(AccessControlTab, {}) })), me?.role === "admin" && (_jsx(TabsContent, { value: "themes", className: "mt-6", children: _jsx(PortalThemesTab, {}) })), _jsx(TabsContent, { value: "about", className: "mt-6", children: _jsx(AboutTab, {}) })] })] }));
}
