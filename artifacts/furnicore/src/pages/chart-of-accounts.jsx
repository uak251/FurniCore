...
export default function ChartOfAccountsPage() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Chart of Accounts" }), _jsx("p", { className: "text-muted-foreground", children: "Manage the master list of ledger accounts used in double-entry bookkeeping." })] }), _jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [_jsxs(Button, { variant: "outline", size: "sm", onClick: handleSampleDownload, title: "Download sample CSV format", children: [_jsx(FileDown, { className: "mr-1.5 h-4 w-4" }), "Sample CSV"] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: handleExport, children: [_jsx(Download, { className: "mr-1.5 h-4 w-4" }), "Export CSV"] }), canWrite && (_jsxs(Button, { variant: "outline", size: "sm", onClick: () => { setImportResult(null); setShowImport(true); }, children: [_jsx(Upload, { className: "mr-1.5 h-4 w-4" }), "Import CSV"] })), isAdmin && (_jsxs(Button, { variant: "outline", size: "sm", onClick: () => seedMutation.mutate(), disabled: seedMutation.isPending, children: [_jsx(Sprout, { className: "mr-1.5 h-4 w-4" }), "Seed standard accounts"] })), canWrite && (_jsxs(Button, { size: "sm", onClick: openCreate, children: [_jsx(Plus, { className: "mr-1.5 h-4 w-4" }), "New Account"] }))] })] }), _jsxs("div", { className: "flex flex-col gap-3 sm:flex-row", children: [_jsxs("div", { className: "relative flex-1", children: [_jsx(Search, { className: "absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }), _jsx(Input, { placeholder: "Search by code or name\u2026", className: "pl-9", value: search, onChange: (e) => setSearch(e.target.value) })] }), _jsxs(Select, { value: typeFilter, onValueChange: setTypeFilter, children: [_jsx(SelectTrigger, { className: "w-40", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "all", children: "All types" }), typeOrder.map((t) => _jsx(SelectItem, { value: t, className: "capitalize", children: t }, t))] })] })] }), !isLoading && (_jsx("div", { className: "flex flex-wrap gap-2", children: typeOrder.map((t) => {
