/**
 * SupplierLayout — isolated shell for the Supplier Portal.
 *
 * Intentionally has NO internal navigation sidebar. Suppliers only
 * see the top header (branding + user badge + logout) and their
