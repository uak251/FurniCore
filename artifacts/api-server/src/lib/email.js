...
const { SMTP_HOST = "smtp.gmail.com", SMTP_PORT = "587", SMTP_USER = "", SMTP_PASS = "", SMTP_FROM = `FurniCore ERP <${SMTP_USER}>`, APP_URL = "http://localhost:5173", EMAIL_ENABLED = "true", } = process.env;
...
export async function sendVerificationEmail(to, name, token) {
    ...
    if (!emailEnabled) {
        console.info(`[email] EMAIL_ENABLED=false — skipping send to ${to}.\n` +
