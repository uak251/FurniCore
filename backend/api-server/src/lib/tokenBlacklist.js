 ...
 */
export async function revokeAccessToken(rawToken, userId, reason = "logout") {
    const hash = hashToken(rawToken);
    const decoded = jwt.decode(rawToken.trim());
...
export async function purgeExpiredBlacklistRows() {
